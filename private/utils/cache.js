...
async function ping() {
  try {
    const testKey = ServerCacheSettings.CACHE_HEALTH_TEST_KEY;
    const testVal = ServerCacheSettings.CACHE_HEALTH_TEST_VALUE;
    set(testKey, testVal, ServerCacheSettings.CACHE_HEALTH_TEST_TTL_MS);
