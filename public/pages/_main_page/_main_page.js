  ...
  const getStats = () => [
    {
      id: "api-endpoints",
      label: "API-Endpunkte",
      value: dynamicStats.apiEndpoints,
      icon: "📡",
      color: "var(--primary)",
    },
    {
      id: "recent-logs",
      label: "Neueste Protokolle",
      value: dynamicStats.recentLogs,
      icon: "📋",
      color: "var(--info)",
    },
    {
      id: "system-status",
      label: "Systemstatus",
      value: dynamicStats.systemStatus,
      icon: "🟢",
      color: "var(--success)",
    },
    {
      id: "log-file-size",
      label: "Log Dateigröße",
      value: dynamicStats.logFileSize,
      icon: "📦",
      color: "var(--warning)",
    },
  ];
  ...
  const pageContent = html`
    <div class="dashboard">
      <div class="dashboard-header">
        ...
        <p>
          Überwachen und testen Sie Ihre APIs von diesem zentralen Dashboard aus
        </p>
      </div>
      ...
      <div class="cards-grid">
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-description">
              Beginnen Sie mit gängigen Aufgaben
            </div>
          </div>
          <div class="action-buttons">
            <button
              class="btn btn-primary"
              onclick="document.getElementById('api_page_btn').click()"
            >
              API-Endpunkte testen
            </button>
            <button
              class="btn btn-secondary"
              onclick="document.getElementById('test_page_btn').click()"
            >
              Test-Suite ausführen
            </button>
            <button
              class="btn btn-secondary"
              onclick="document.getElementById('log_page_btn').click()"
            >
        ...
        <div class="card">
          ...
          <div class="health-indicators">
            <div class="health-item" id="health-item-api">
              ...
              <span class="health-status" id="health-status-api"
                >Wird überprüft…</span
              >
            </div>
            <div class="health-item" id="health-item-db">
              ...
              ></span>
              <span>Datenbank</span>
              <span class="health-status" id="health-status-db"
                >Wird überprüft…</span
              >
            </div>
            <div class="health-item" id="health-item-cache">
              ...
              ></span>
              <span>Cache</span>
              <span class="health-status" id="health-status-cache"
                >Wird überprüft…</span
              >
            </div>
            <div class="health-item" id="health-item-monitor">
              <span
                class="health-dot"
                id="health-dot-monitor"
                style="background: var(--surface)"
              ></span>
              <span>Überwachung</span>
              <span class="health-status" id="health-status-monitor"
                >Wird überprüft…</span
              >
            </div>
          </div>
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-description">
              Neueste API-Aufrufe und Ereignisse
            </div>
          </div>
...
export function onMount(rootElement) {
  ...
  setTimeout(
    fetchDashboardStats,
    MainPageSettings.DASHBOARD_INITIAL_FETCH_DELAY_MS
  );
