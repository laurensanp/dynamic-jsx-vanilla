...
async function updateActivityFeed() {
  ...
  if (!res.ok) { container.innerHTML = '<div class="activity-item"><div class="activity-text">Fehler beim Laden der Aktivitäten</div></div>'; success = false; return { success }; }
...
export { fetchApiEndpoints, fetchLogsCount, checkSystemStatus, updateHealthCard, updateActivityFeed, fetchLogFileSize };
